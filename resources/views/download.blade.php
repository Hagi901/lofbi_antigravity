...
<script>
    ...
    // 1. Fungsi Cetak PDF Aset (Sudah Terhubung ke Controller)
    document.getElementById('btn-pdf-aset').addEventListener('click', function() { 
        simulateDownload('PDF', 'Laporan Aset'); 
        
        // Arahkan ke URL download setelah animasi loading selesai (2 detik)
        setTimeout(function() {
            window.location.href = "{{ route('reports.aset.pdf') }}";
        }, 2000);
    });

    // Tombol lainnya (Sementara masih simulasi)
